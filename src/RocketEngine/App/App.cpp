...
namespace rocketengine::app
{
    ...
    void App::run() noexcept
    {
        ...
        while (true) {
            ...
            double const elapsed_time_in_seconds = static_cast<double>(std::chrono::duration_cast<double_secs>(std::chrono::steady_clock::now() - start_time).count());

            std::cout << "Running since: " << elapsed_time_in_seconds << " seconds" << '\n';
    ...
    void App::waitUntilNextFrame() noexcept
    {
        ...
        std::cout << "Frame time: " << frame_time_in_seconds << " seconds" << '\n';
        std::cout << "Elapsed time: " << delta_time_in_seconds << " seconds" << '\n';
        if (delta_time_in_seconds < frame_time_in_seconds) {
            ...
            std::cout << "Sleeping for " << sleep_time_in_seconds << " seconds" << '\n';
            std::cout << "Sleeping for " << sleep_time_in_microseconds << " microseconds" << '\n';
